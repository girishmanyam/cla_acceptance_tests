...
public class CLA_WebProblemPage extends SeleniumPage {
	...
	private String expectedTextOnPage = "Choose the area you most need help with";
	private By expectedTextOnPageSelector = new By.ByXPath(
			".//*[@id='content']/div/article/h1");

	
	private By clinicalNegligence = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[1]/a");
	private By communityCare      = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[2]/a");
	private By debt               = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[3]/a");
	private By domesticViolence   = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[4]/a");
	private By discrimination     = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[5]/a");
	private By education          = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[6]/a");
	private By employment         = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[7]/a");
	private By family             = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[8]/a");
	private By housing            = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[9]/a");
	private By immigrationAndAsylum = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[10]/a");
	private By mentalHealth         = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[11]/a");
	private By personalInjury       = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[12]/a");
	private By publicLaw            = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[13]/a");
	private By troubleWithThePolice = new By.ByXPath(".//*[@id='content']/div/article/div/ul/li[14]/a");
