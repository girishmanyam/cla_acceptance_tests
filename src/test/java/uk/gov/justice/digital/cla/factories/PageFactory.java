...
import uk.gov.justice.digital.cla.web.pages.CLA_WebHousingWhatDoYouNeedHelpWithPage;
import uk.gov.justice.digital.cla.web.pages.CLA_WebImmigrationAndAsylumFindALegalAdvisorPage;
import uk.gov.justice.digital.cla.web.pages.CLA_WebImmigrationAndAsylumWhatDoYouNeedHelpWithPage;
...
public class PageFactory {
	...
	public static CLA_WebYouMaybeAbleToGetLegalAidForFamilyMediation getCLAWebYouMaybeAbleToGetLegalAidForFamilyMediationPage(WebDriver driver){
		return new CLA_WebYouMaybeAbleToGetLegalAidForFamilyMediation(driver);
	}
	
	public static CLA_WebDiscriminationWhatDoYouNeedHelpWithPage getCLAWebDiscriminationWhatDoYouNeedHelpWithPage(WebDriver driver){
		return new CLA_WebDiscriminationWhatDoYouNeedHelpWithPage(driver);
	}
	
	public static CLA_WebImmigrationAndAsylumWhatDoYouNeedHelpWithPage getCLA_WebImmigrationAndAsylumWhatDoYouNeedHelpWithPage(WebDriver driver){
		return new CLA_WebImmigrationAndAsylumWhatDoYouNeedHelpWithPage(driver);
	}
	
	public static CLA_WebLegalAidIsAvailableForThisProblemPage getCLA_WebLegalAidIsAvailableForThisProblemPage(WebDriver driver){
		return new CLA_WebLegalAidIsAvailableForThisProblemPage(driver);
	}
	
	public static CLA_WebHousingWhatDoYouNeedHelpWithPage getCLA_WebHousingWhatDoYouNeedHelpWithPage(WebDriver driver){
		return new CLA_WebHousingWhatDoYouNeedHelpWithPage(driver);
	}
