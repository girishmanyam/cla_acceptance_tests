...
public class EducationScopeAssessmentSteps {
	...
	public void i_am_redirected_to_the_education_what_do_you_need_help_with_page() throws Throwable {
	    assertTrue(PageFactory.getCLAWebEducationWhatDoYouNeedHelpWithPage(driver).verifyOnPage());
	}
